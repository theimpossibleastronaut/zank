...
Thank you for your interest in Zank.
...
1. [Fork the
repo](https://github.com/theimpossibleastronaut/Zank#fork-destination-box)
...
1. [Configuring a remote for a fork](https://help.github.com/articles/configuring-a-remote-for-a-fork/)
    * For step 3 on that page, use https://github.com/theimpossibleastronaut/Zank
    for the URL.
